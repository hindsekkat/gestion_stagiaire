...
public class Stagiaires_en_instance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Stagiaires en instance");
        ...
        PanelChoisirSessionLayout.setVerticalGroup(
            ...
            .addGroup(PanelChoisirSessionLayout.createSequentialGroup()
                ...
                .addGroup(PanelChoisirSessionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(RejeterBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery( "SELECT * FROM stagiaire WHERE "+combo()
                +"  like '%"+RechercheText.getText()+"%'and Validation=0 and Rejet=0" );
...
System.err.println(m);
    ...
    private void AfficherStagiaire(){
       ...
       try{
        ...
        rs = st.executeQuery("Select * From stagiaire where Validation=0 and Rejet=0");
...
public void Valider(int i){
    try{ 
        ...
        if (JOptionPane.showConfirmDialog(null, " Confirmez la validation "," Validation ",
            ...
            rs = st.executeQuery("Select Division,Fin_stage From stagiaire where Fin_stage>=now() and Debut_stage<=now() and Validation=1 "); 
            boolean valid=true;
            while(rs.next()){
...
public void Rejeter(int i){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stagiaires_en_instance().setVisible(true);
            }
        });
    }

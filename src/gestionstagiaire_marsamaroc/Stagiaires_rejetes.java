...
public class Stagiaires_rejetes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        affichTable.setBackground(new java.awt.Color(255, 0, 0));
        ...
        jLabel1.setText("Stagiaires Rejetés");
    ...
    Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery( "SELECT * FROM stagiaire WHERE "+combo()
                +"  like '%"+RechercheText.getText()+"%' and Rejet=1 " );
...
System.err.println(m);
    ...
    private void AfficherStagiaire(){
       ...
       try{
        ...
        rs = st.executeQuery("Select * From stagiaire where Rejet=1");
...
String combo(){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stagiaires_rejetes().setVisible(true);
            }
        });
    }

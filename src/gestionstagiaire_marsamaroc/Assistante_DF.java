...
public class Assistante_DF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DirectionjComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DF" }));

        DivisionjComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----------", "Gestion et Planification Financiere", "Gestion Comptable et Fiscale", "Financiere et Comptable du Siege", "Consolidation et Gestion des Participations", "Controle  Budgetaire", "Evaluation des Performances", "Pilotage Strategique" }));
    ...
    Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery( "SELECT * FROM stagiaire WHERE "+combo()
                +"  like '%"+RechercheText.getText()+"%'and Direction='DF'" );
...
System.err.println(m);
    ...
    private void AfficherStagiaire(){
       ...
       try{
        ...
        rs = st.executeQuery("Select * From stagiaire where Direction='DF'");
...
String combo(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Assistante_DF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Assistante_DF().setVisible(true);
            }
        });
    }

...
public class Assistante_DDS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DirectionjComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DDS" }));

        DivisionjComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----------", "Planification Strategique", "Prospection et Partenariats", "Etudes" }));
    ...
    Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery( "SELECT * FROM stagiaire WHERE "+combo()
                +"  like '%"+RechercheText.getText()+"%'and Direction='DDS'" );
...
System.err.println(m);
    ...
    private void AfficherStagiaire(){
       ...
       try{
        ...
        rs = st.executeQuery("Select * From stagiaire where Direction='DDS'");
...
String combo(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Assistante_DDS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Assistante_DDS().setVisible(true);
            }
        });
    }

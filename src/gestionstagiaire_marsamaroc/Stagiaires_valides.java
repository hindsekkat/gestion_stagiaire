...
public class Stagiaires_valides extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Stagiaires Validés");
    ...
    Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery( "SELECT * FROM stagiaire WHERE "+combo()
                +"  like '%"+RechercheText.getText()+"%' and Validation=1 " );
...
System.err.println(m);
    ...
    private void AfficherStagiaire(){
       ...
       try{
        ...
        rs = st.executeQuery("Select * From stagiaire where Validation=1");
...
String combo(){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stagiaires_valides().setVisible(true);
            }
        });
    }

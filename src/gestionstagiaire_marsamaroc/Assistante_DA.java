...
public class Assistante_DA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DirectionjComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DA" }));

        DivisionjComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----------", "Support", "Achats des Frais Generaux", "Achats des Equipements & Maintenance" }));
    ...
    Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery( "SELECT * FROM stagiaire WHERE "+combo()
                +"  like '%"+RechercheText.getText()+"%'and Direction='DA'" );
...
System.err.println(m);
    ...
    private void AfficherStagiaire(){
       ...
       try{
        ...
        rs = st.executeQuery("Select * From stagiaire where Direction='DA'");
...
String combo(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Assistante_DA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Assistante_DA().setVisible(true);
            }
        });
    }

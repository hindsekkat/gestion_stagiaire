...
public class Assistante_DRH extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DirectionjComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DRH" }));

        DivisionjComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----------", "Developpement des ressources humaines", "Gestion des Remunerations", "Administrative et Relations sociales", "Mutuelle/Couverture Medicale", "Gestion des Centres de Vacances", "Affaires generales" }));
    ...
    Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery( "SELECT * FROM stagiaire WHERE "+combo()
                +"  like '%"+RechercheText.getText()+"%'and Direction='DRH'" );
...
System.err.println(m);
    ...
    private void AfficherStagiaire(){
       ...
       try{
        ...
        rs = st.executeQuery("Select * From stagiaire where Direction='DRH'");
...
String combo(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Assistante_DRH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Assistante_DRH().setVisible(true);
            }
        });
    }
